...
export const en = {
  ...
  "preview.preparing": "Preparing a compatible video preview…",
  "preview.error": "This video preview could not be prepared. The original file is still safe for export.",
  ...
  "editor.hideCleanupSidebar": "Hide cleanup sidebar",
  "editor.showCleanupSidebar": "Show cleanup sidebar",
  "editor.hideVideoPreview": "Hide video preview",
  "editor.showVideoPreview": "Show video preview",
  ...
  "transcript.applyCorrection": "Apply correction",
  "transcript.selectionActions": "Selection actions",
  "transcript.markFiller": "Mark as filler",
  "transcript.unmarkFiller": "Unmark filler",
  ...
  "transcript.silencePreview": "Silence preview, {seconds} seconds — still plays until removed",
  "tools.bulk": "Bulk transcript cleanups",
  "tools.cleanupSidebar": "Cleanup",
  "tools.removeFillers": "Remove filler words",
  "tools.fillerCleanup": "Filler words",
  "tools.fillerCleanupHelp": "Review built-in and personal filler words. Highlighted words still play until removed.",
  "tools.customFillers": "Your filler words",
  "tools.customFillersHelp": "Saved on this device and used for every project.",
  "tools.customFillerPlaceholder": "like, you know…",
  "tools.addCustomFiller": "Add filler word or phrase",
  "tools.removeCustomFiller": "Remove {filler} from your filler words",
  "tools.noCustomFillers": "Add a word or short phrase you often want to remove.",
  "tools.builtInFillersTitle": "Built in",
  "tools.builtInFillersHelp": "um, uh, erm, ah, hesitations, and localized equivalents.",
  ...
  "tools.removeSilencesTitle": "Preview silences from {min}s to {max}s before removing them",
  "tools.removePauses": "Remove pauses",
  "tools.removePausesTitle": "Preview transcript pauses from {min}s to {max}s",
  "tools.removeQuietAudio": "Remove quiet audio",
  "tools.removeQuietAudioTitle": "Preview quiet waveform sections from {min}s to {max}s",
  "tools.pauseCleanup": "Pauses",
  "tools.pauseCleanupHelp": "Find gaps where no words were transcribed. Orange ranges still play until removed.",
  "tools.quietAudioCleanup": "Quiet audio",
  "tools.quietAudioCleanupHelp": "Find low waveform sections outside recognized words. Transcript speech stays protected.",
  "tools.pauseDurationRange": "Original pause duration",
  "tools.quietDurationRange": "Original quiet-section duration",
  "tools.durationBeforePaddingHelp": "Duration is measured before padding; padding shortens the resulting cut.",
  "tools.removeDetectedPauses": "Remove pauses ({count})",
  "tools.removeDetectedQuietAudio": "Remove quiet audio ({count})",
  "tools.noMatchingPauses": "No matching pauses",
  "tools.noMatchingQuietAudio": "No matching quiet audio",
  "tools.restoreSilences": "Restore silences",
  "tools.restoreSilencesTitle": "Bring every cut pause back",
  "tools.silenceCleanup": "Silence cleanup",
  "tools.silenceCleanupHelp": "Orange ranges are playable previews. Adjust the controls, then remove them.",
  "tools.silencePresets": "Silence presets",
  "tools.punchyPreset": "Punchy · 0.13s / 0",
  "tools.defaultPreset": "Default · 0.3s / 0.05",
  "tools.loudnessThreshold": "Loudness threshold",
  ...
  "tools.bothPadding": "Both sides",
  "tools.leftPadding": "Left",
  "tools.rightPadding": "Right",
  "tools.linkPadding": "Link left and right padding",
  "tools.unlinkPadding": "Adjust left and right padding separately",
  "tools.paddingLinked": "Linked",
  "tools.paddingIndependent": "Separate",
  "tools.moreInfo": "More information about {topic}",
  "tools.protectLongPauses": "Protect long pauses",
  "tools.protectLongPausesHelp": "Leave deliberate pauses above this length untouched.",
  "tools.longestPauseToRemove": "Longest pause to remove",
  "tools.removeDetectedSilences": "Remove silences ({count})",
  "tools.noMatchingSilences": "No matching silences",
