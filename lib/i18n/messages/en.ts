...
export const en = {
  ...
  "tools.fillerCleanupHelp": "Review built-in and personal filler words. Amber words still play until removed.",
  ...
  "tools.builtInFillersHelp": "Built in: um, uh, erm, ah, hesitations, and localized equivalents.",
